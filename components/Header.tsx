...
const Header: React.FC<HeaderProps> = ({ onNavigateHome, onNavigate, playIntro }) => {
  const { t } = useI8n();
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-baseline space-x-2">
              <button
                ...
                className="flex items-center space-x-3 group focus:outline-none focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark rounded-full p-2 -ml-2"
              >
              ...
              <div className="hidden sm:block">
                <button onClick={() => onNavigate('changelog')} className="focus:outline-none focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark rounded-full">
